    ...
    return (
      <Html lang="en">
        <Head>
          ...
          />
          <link href="https://fonts.googleapis.com/css2?family=Inter:wght@200;300;400&family=Manrope:wght@200;300;400;500;600;700;800&display=swap" rel="stylesheet" />
        </Head>
        <body style={{ overflow: 'unset', margin: 0, width: "100%", height: "100%", backgroundColor: "#161822" }}>
          <Main />
          <NextScript />
        </body>
      </Html>
